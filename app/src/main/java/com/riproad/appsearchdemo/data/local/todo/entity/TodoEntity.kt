package com.riproad.appsearchdemo.data.local.todo.entity
...
data class TodoEntity(
    ...
    @Id val id: String,
    @Score val score: Int,
    @StringProperty(indexingType = AppSearchSchema.StringPropertyConfig.INDEXING_TYPE_PREFIXES) val title: String,
    @StringProperty(indexingType = AppSearchSchema.StringPropertyConfig.INDEXING_TYPE_PREFIXES) val text: String,
    @BooleanProperty val done: Boolean
)
